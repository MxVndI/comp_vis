...
class AudioDenoiser:
    ...
    def process(
        ...
        if audio_data.ndim == 2:  # если стерео
...
denoiser.process(
    "C:\\Users\\LesunVo\\Desktop\\PythonProject\\lab5\\Desktop.wav",
    "C:\\Users\\LesunVo\\Desktop\\PythonProject\\lab5\\output.wav",
    noise_dur_sec=1,
    noise_reduction_strength=7,
    min_signal_level=0.005,
)
